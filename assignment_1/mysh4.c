...
//se entoles analoga me to pou vriskontai oi pipe operatorkai to posoi pipe operator yparxoun

{
  int  pos_1=-1;
  
  char *token_1;
  char **tokens_1 = malloc(4096 * sizeof(char*)); //dhmiourgia enos 2d pinaka string gia thn apothikeysh twn
  //entolwn me megisto arithmo entolwn 4096
...
for (int j=0;j<poss;j++)	{  //to plithos twn entolwn einai h timh tou poss 
//epanalipseis oses kai to plithos twn entolwn
  countc = -1;
